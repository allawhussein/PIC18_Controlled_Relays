...
void RTC_Set_Time(char sec, char min, char hour);
void RTC_Set_Date(char day, char date, char month, char year);
...
void RTC_Set_Time(char sec, char min, char hour)
{
 ...
 I2C_Start(0xD0);
 I2C_Write(0);
 I2C_Write((((sec % 10) & (0x0F)) + (((sec /10) << 4 ) & (0xF0))));
 I2C_Write((((min % 10) & (0x0F)) + (((min /10) << 4 ) & (0xF0))));
 I2C_Write((((hour % 10) & (0x0F)) + (((hour /10) << 4 ) & (0xF0))));
 I2C_Stop();
}
...
void RTC_Set_Date(char day, char date, char month, char year)
{
 I2C_Start(0xD0);
 I2C_Write(3);
 I2C_Write((((day % 10) & (0x0F)) + (((day /10) << 4 ) & (0xF0))));
 I2C_Write((((date % 10) & (0x0F)) + (((date /10) << 4 ) & (0xF0))));
 I2C_Write((((month % 10) & (0x0F)) + (((month /10) << 4 ) & (0xF0))));
 I2C_Write((((year % 10) & (0x0F)) + (((year /10) << 4 ) & (0xF0))));
 I2C_Stop();
}
